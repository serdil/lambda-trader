...
backtest.backtest(account, market_info, [VolumeStrategy(1), VolumeStrategy(2), VolumeStrategy(3), VolumeStrategy(4), VolumeStrategy(5), VolumeStrategy(6), VolumeStrategy(7)])
