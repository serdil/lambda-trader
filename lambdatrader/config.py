...
EXECUTOR__MIN_CHUNK_SIZE = env('EXECUTOR__MIN_CHUNK_SIZE', DEFAULT_EXECUTOR__MIN_CHUNK_SIZE, float)
...
SHELVE_CACHE_DIRECTORY = os.path.join(DATA_DIRECTORY, 'shelve_cache')
