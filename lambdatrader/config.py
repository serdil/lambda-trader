...
DEFAULT_HISTORY_DB_DIR = str(os.path.join(get_project_directory(), 'db'))
...
HISTORY_DB_DIR_ENV_VAR = 'HISTORY_DB_DOCKER_DIR' if running_in_docker() else 'HISTORY_DB_HOST_DIR'
HISTORY_DB_DIR = env(HISTORY_DB_DIR_ENV_VAR, DEFAULT_HISTORY_DB_DIR)
