...
from lambdatrader.config import (
    ...
    RETRACEMENT_SIGNALS__MIN_NUM_HIGH_VOLUME_PAIRS, RETRACEMENT_SIGNALS__BUY_PROFIT_FACTOR,
...
class PolxStrategy:
    ...
    MIN_NUM_HIGH_VOLUME_PAIRS = RETRACEMENT_SIGNALS__MIN_NUM_HIGH_VOLUME_PAIRS
