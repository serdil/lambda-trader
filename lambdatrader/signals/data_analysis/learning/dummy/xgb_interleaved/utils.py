...
def get_train_val_test_Xs_ys_feature_names(symbols, feature_set,
...
def get_close_dmatrix(symbols, feature_set, val_ratio, test_ratio, num_candles, day_offset, days):
    ...
    y_max_test, feature_names = get_train_val_test_Xs_ys_feature_names(symbols=symbols,
                                                                       val_ratio=val_ratio,
                                                                       test_ratio=test_ratio,
                                                                       num_candles=num_candles,
                                                                       day_offset=day_offset,
...
def train_close(params, num_rounds, early_stopping_rounds,
                symbols, feature_set, val_ratio, test_ratio, num_candles, day_offset, days):
...
def train_max(params, num_rounds, early_stopping_rounds,
              symbols, feature_set, val_ratio, test_ratio, num_candles, day_offset, days):
    dtrain_max, dval_max, dtest_max = get_max_dmatrix(symbols=symbols,
                                                      feature_set=feature_set,
                                                      val_ratio=val_ratio,
                                                      test_ratio=test_ratio,
                                                      num_candles=num_candles,
