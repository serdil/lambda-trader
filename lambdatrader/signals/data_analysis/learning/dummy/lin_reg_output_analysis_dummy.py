...
tp_level = 0.8
compute_profit = lambda a: max_pred_key(a) * tp_level if close_pred_key(a) > 0 and max_real_key(a) >= max_pred_key(a) * tp_level else close_real_key(a)
one_for_tp_hit_else_zero = lambda a: 1 if close_pred_key(a) > 0 and max_real_key(a) >= max_pred_key(a) * tp_level else 0
...
for a in pred_real_max_min_close_profit[-1000:]:
    print(a)
